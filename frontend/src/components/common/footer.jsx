    ...
    <footer className='bg-primary text-gray-100 py-12'>
      <div className='container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 px-6'>
        <div>
          ...
          <p className='text-sm mt-2'>KEMIRI - PURWOREJO - JAWA TENGAH</p>
          <p
            className={`mt-4 ${
              lineClimb ? "line-clamp-3" : "line-clamp-none"
            } text-justify`}
          >
            ...
            oleh masyarakat sebagai penerima manfaat. Selanjutnya website desa
            akan memiliki fungsi sebagai portal pelayanan secara online untuk
            mendekatkan dan meningkatkan kualitas pelayanan masyarakat baik yang
            bersifat administratif maupun aspiratif.
          </p>
          <span
            onClick={() => setLineClimb(!lineClimb)}
            className='cursor-pointer'
          >
            {lineClimb ? "Lebih banyak..." : "Lebih Sedikit..."}
          </span>
        </div>
        ...
        <div>
          ...
          <ul className='mt-4 space-y-2 text-gray-300'>
            <li>
              <a
                href='https://www.purworejokab.go.id/'
                target='_blank'
        ...
        <div>
          <h2 className='text-lg font-bold'>Kontak Pemerintahan</h2>
          <p className='mt-4'>
            Balai Desa Sukogelap
            <br />
            9V8C+PHV, Krajan Tengah, Sokogelap, Kec. Kemiri, Kabupaten
            Purworejo, Jawa Tengah 54262
          </p>
          <p className='mt-4'>
            <strong>Telepon:</strong> 022-6623181
          </p>
          <p className='mt-2'>
            <strong>Email:</strong> pemdes@sukogelap-kemiri.desa.id
          </p>
        </div>
      </div>

      <div className='container mx-auto mt-8 border-t border-gray-600 pt-6 px-6 text-center flex flex-col justify-center'>
